...
add_requires("cpr ^1.10.5", "indicators ^2.3", "eigen ^3.4.0")
...
target("graphkit")
    ...
    add_packages("libarchive", "cpr", "eigen", {public = true})
    add_deps("graphkit/utils")

target("graphkit/test")
    set_kind("binary")
